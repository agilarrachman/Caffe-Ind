...
<body>
    ...
    <div class="landing-page">
        <div class="container">
            ...
            <div class="content" data-aos="zoom-in-up">
                ...
                <div class="teks">
                    <div class="heading">
                        <h1>MONITORING KONSUMSI KOPIMU</h1>
                        <h1>Dengan Caffe-Ind</h1>
                    </div>
                    <div class="subheading">
                        <h2>Coba dari mana saja mulai dari sekarang</h2>
                    </div>
                </div>
                <div class="button">
                    <a href="konsumen/login.php">Get Started</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="image"  data-aos="zoom-in-up">
                    <img src="assets/kopi 3d dampak.png" alt="">
                </div>
                <div class="right" data-aos="fade-left">
                    <div class="heading">
                        <h2>Bahaya Minum Kopi Berlebihan</h2>
                    </div>
    ...
    <div class="monitoring">
        <hr class="line-monitoring">
        <div class="content">
            <div class="left" data-aos="fade-right">
                <img src="assets/monitoring.png" alt="monitoring">
            </div>
            <div class="right" data-aos="fade-left">
                <div class="heading">
                    <h2>Monitoring Konsumsi Kopimu</h2>
                </div>
                <div class="paragraph">
                    <p>Pantau kebiasaan minum kopi Anda dengan ringkasan harian dan mingguan, dan ketahui informasi terperinci tentang kandungan kopi yang Anda konsumsi, termasuk kadar kafein dan gula.</p>
                </div>
                <div class="button">
                    <a href="konsumen/login.php">Log In</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="overlaybot-download">
        <img src="assets/tekstur kertas.png" alt="" class="overlay-bot">
    </div>

    <hr class="line-after-download">

    <div class="overlaytop-contact">
        <img src="assets/tekstur kertas.png" alt="" class="overlay-top">
    </div>
