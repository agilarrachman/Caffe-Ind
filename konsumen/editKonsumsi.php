...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/editKonsumsi.css">
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    <!-- Javascript -->
    <script src="js/script.js"></script>
    <script src="js/fillEditKonsumsi.js"></script>
</head>
...
<body>
    ...
    <div class="input" id="input-section">
        <div class="background">
            <div class="container">
                <h2>Pilih menu kopi yang kamu minum</h2>
                    ...
                    <div class="container-inputKopi">
                        ...
                        foreach ($data as $row) {
                            ...
                            if (!in_array($row->nama, $namaSudahDitampilkan)) {
                                echo '<div class="card-input" data-nama-kopi="' . (empty($row->nama) ? '' : $row->nama) . '">
                                        <div class="content">
                    ...
                    <div class="info-lebihlanjut">
                        <div class="container">
                            <div class="content-form">
                                <div class="card-form">
                                    ...
                                    <div class="form-info-lebihlanjut">
                                        ...
                                        <div class="input-lebihlanjut" id="penyajian">
                                            <p>Hot/Cold?</p>
                                            <select class="form-select form-select-lg" aria-label="Large select example" name="penyajian">
                                ...
                                <img src="assets/coffeeKuning.png" alt="">
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="overlaytop-footer">
        <img src="assets/tekstur kertas merah.png" alt="" class="overlay-top">
    </div>
