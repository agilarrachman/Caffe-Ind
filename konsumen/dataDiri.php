<?php
    ...
    $options = array(
        CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-yuxyg/endpoint/verifikasiLoginKonsumen?username='.$username."&password=".$password,
            ...
            <div class="card-form">
                ...
                <div class="content-form">
                    <div class="form">
                        ...
                        <form action="saveDataKonsumen.php" method="get">
