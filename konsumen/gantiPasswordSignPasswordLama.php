...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="css/gantiPasswordSignPasswordLama.css">
  <!-- Library AOS -->
  ...
  <div class="gantiPassword">
    ...
    <div class="container">
      <div class="card-form" data-aos="zoom-in-up">
        ...
        <div class="form">
          <form action="verifikasiPassword.php" method="get">
            <div class="input">
              <h4>Masukkan Password Saat Ini</h4>
              <input type="password" placeholder="Password" name="password" id="password" required>
            </div>
            <button type="submit" id="button-ganti-password">Konfirmasi</button>
          </form>
        </div>
      </div>
    </div>
