            ...
            <div class="card-form" data-aos="zoom-in-up">
                ...
                <div class="content-form">
                    ...
                    <div class="data-profil">
                        ...
                        <div class="data">
                            <h4>Tinggi Badan</h4>
                            <p><?php echo $tinggi_badan ?> cm</p>
                        </div>
                        <div class="data">
                            <h4>Berat Badan</h4>
                            <p><?php echo $berat_badan ?> kg</p>
                        </div>

                        <?php
                        $style = ($jenis_kelamin == 'Wanita') ? 'style="display: block;"' : 'style="display: none;"';
                        ?>

                        <div class="data" <?php echo $style; ?>>
                            <h4>Status Kehamilan</h4>
                            <p><?php echo $status_kehamilan ?></p>
                        </div>
                        <div class="data">
                            <h4>Riwayat Penyakit</h4>
                            <ul>
                                <?php
                                // Melakukan loop untuk setiap penyakit dalam array riwayat_penyakit
                        ...
                        <a href="userpage.php" id="button-data-diri">
