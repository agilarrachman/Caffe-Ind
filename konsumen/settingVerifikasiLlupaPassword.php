...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/settingVerifikasiLlupaPassword.css">
    <!-- Library AOS -->
    ...
    <script src="js/fillVerifikasiLupaPassword.js"></script>
    ...
    <div class="lupaPassword">
        ...
        <div class="container">
            <div class="card-form" data-aos="zoom-in-up">
                ...
                <div class="form">
                    <p>Untuk memverifikasi identitas kamu</p>
                    <form action="saveVerifikasiLupaPassword.php" method="get">
                        <div class="mb-3 input-pertanyaan">
                            <h4>Pilih pertanyaan keamanan</h4>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pertanyaan_lupa_password" id="ibu" value="Siapa nama ibu kamu?">
                                <label class="form-check-label" for="ibu">
                                    Siapa nama ibu kamu?
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pertanyaan_lupa_password" id="ayah" value="Siapa nama Ayah kamu?">
                                <label class="form-check-label" for="ayah">
                                    Siapa nama Ayah kamu?
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pertanyaan_lupa_password" id="makanan" value="Apa makanan favorit kamu?">
                                <label class="form-check-label" for="makanan">
                                    Apa makanan favorit kamu?
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pertanyaan_lupa_password" id="cinta" value="Siapa cinta pertamamu?">
                                <label class="form-check-label" for="cinta">
                                    Siapa cinta pertamamu?
                                </label>
                            </div>
                        </div>
                        <div class="input">
                            <h4>Masukkan Jawaban</h4>
                            <input type="text" placeholder="Masukkan jawaban kamu" name="jawaban_lupa_password" id="jawaban_lupa_password" required>
                            <input type="hidden" id="id" name="id" value="<?php echo $user_id; ?>">
                        </div>
                        <button type="submit" id="button-konfirmasi">Konfirmasi</button>
                    </form>
                </div>
            </div>
        </div>
