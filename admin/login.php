...
if (isset($_GET['code'])) {
    ...
    $options = array(
        CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-yuxyg/endpoint/getAdminByEmail?email=' . $google_info->email,
        ...
        <div class="container" data-aos="zoom-in-up">
            <div class="card-form" >
                <div class="judul-form">
                    <h2>Sign In Admin</h2>
                    <p>Masuk sebagai Konsumen? <a href="../konsumen/login.php">Klik disini</a></p>
                </div>
